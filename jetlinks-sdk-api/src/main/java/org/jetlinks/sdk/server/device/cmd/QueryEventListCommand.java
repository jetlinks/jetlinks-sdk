 ...
 * @since 1.0
 */
public class QueryEventListCommand extends QueryListCommand<DeviceEvent> {

    public String getEventId() {
        return (String) readable().get("eventId");
    }

    public QueryEventListCommand withEventId(String eventId) {
    ...
    public QueryEventListCommand withDeviceId(String deviceId) {
    ...
    public QueryEventListCommand withProductId(String productId) {
